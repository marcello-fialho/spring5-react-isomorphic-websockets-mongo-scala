...
const setup = propOverrides => {
  const props = Object.assign({
    ...
    actions: {
      ...
      beforeCompleteAllTodos: jest.fn(),
      beforeClearCompleted: jest.fn()
    }
  }, propOverrides)
  ...
  describe('MainSection', () => {
    ...
    describe('toggle all input', () => {
      ...
      it('should call completeAllTodos on change', () => {
        ...
        label.props.onClick({})
        expect(props.actions.beforeCompleteAllTodos).toBeCalled()
      })
    })
    ...
    describe('footer', () => {
      ...
      it('onClearCompleted should call beforeClearCompleted', () => {
        const { output, props } = setup()
        const [ , , footer ] = output.props.children
        footer.props.onClearCompleted()
        expect(props.actions.beforeClearCompleted).toBeCalled()
      })
    })
